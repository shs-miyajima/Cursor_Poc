...
## 6. Design再現確認（design_mode: canonical の場合）

<!--
canonical の場合のみ、03-test-plan.md で定めた代表画面・主要状態の比較結果を記録する。
reference / none の場合は「対象外」と理由を記載する。
-->

| 対象画面・状態 | 比較方法 | 結果 | 差分・理由 | エビデンスパス |
|---------------|----------|------|-----------|----------------|
| | | | | |
