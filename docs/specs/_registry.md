...
| survey-system | アンケート作成・回答・管理システム | TBD | tests/test_survey_*.spec.ts（10 ファイル、03-test-plan.md §5 参照） | フェーズ 4 完了（PHPUnit 43・Vitest 9 全件成功。E2E 192 件はコード実装済み・環境制約で実行保留） |
